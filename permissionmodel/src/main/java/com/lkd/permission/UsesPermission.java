...
import com.lkd.permission.handle.Handle;
import com.lkd.permission.view.Request;
import com.lkd.permission.view.Settings;
...
public abstract class UsesPermission {
    ...
    public String BuildTips(boolean isCancel, boolean notEmpty, int countX, @NonNull ArrayList<String> permissions, boolean isFinal){
        String names= XXPermission.QueryNames(permissions);
    ...
    private void run() {
        ...
        for (String item : Permissions) {
            ...
            XXPermission.Item pItem = XXPermission.QueryItem(item);
            if (pItem != null) {
    ...
    private void __execHandleGrant_item(int baseCount, Handle.CheckResult res, final String permission, final Runnable run){
        ...
        new Runnable() {
            @Override
            public void run() {
                XXPermission.Item pItem= XXPermission.QueryItem(permission);
